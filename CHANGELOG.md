...
- **Snapshot testing**: Golden-file visual regression tests for all 10 approved components. Each renders with canonical props and compares against a `.txt` file in `tests/snapshots/`. Regenerate with `UPDATE_SNAPSHOTS=1`. 119 total tests (109 functional + 10 snapshots).
